...
class MNIST(VisionDataset):
    ...
    def __getitem__(self, index: int) -> Tuple[Any, Any]:
        ...
        img = Image.fromarray(img.numpy(), mode="L") if isinstance(img, torch.Tensor) else Image.fromarray(img, mode="L")
        ...
        img = F.resize(img, get_dataset_info(general_args.dataset)['img_size'])
